...
func _randomize_position():
    var target_pos = original_pos + Vector3(0, randf() * 2 + 2, -2)
    pos_tween.interpolate_property(self, "translation:z", translation.z, target_pos.z, 2.0, Tween.TRANS_QUAD, Tween.EASE_IN)
    pos_tween.interpolate_property(self, "translation:y", translation.y, target_pos.y, 2.0, Tween.TRANS_QUAD, Tween.EASE_OUT)
    pos_tween.start()
